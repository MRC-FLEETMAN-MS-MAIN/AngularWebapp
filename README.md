...
>> As its a micro-service based system, it is Programming language independent. Some of the microservices were developed on Java and NodeJS.

>> The employment of messaging queues like ( RabbitMQ, ActiveMQ(Optional)) for Asychronous communication.
