...
Regarding the frontend web microservice, the angualr application was deployed in a nginx container which act as a static web server and  Reverse proxy(ingress controller). The K8S deployment of the same fleetman management system is done in another organziation and the link for the same is <a href="https://github.com/fleetmanMS-K8S"> K8S Fleetman management system deployment </a>
